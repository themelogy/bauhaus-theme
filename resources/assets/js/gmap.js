...
function initialize() {
    ...
    + '<div class="map-title">'
    + '<div class="brand" href="#"><img alt="" src="images/logos/logo-wt.svg"><div class="brand-info"><div class="brand-name">bauhaus</div><div class="brand-text">architecture</div></div></div></div>'
    + '<p class="map-address">'
